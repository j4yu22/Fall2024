...
#      This program implements the Sub-List Sort algorithm to sort an array by first identifying 
#      sorted sub-lists (runs), merging them into a destination array, and copying the results 
#      back until the array is fully sorted.
# 4. What was the hardest part? Be as specific as possible.
#      The most challenging part was managing the merging of runs efficiently and makeing sure
#      the program handles edge cases, such as runs with repeated elements and handling an 
#      already sorted list without unnecessary passes.
...
def merge_runs_into_destination(runs, destination_array):
    ...
    while runs:
        ...
        # Extract the smallest element and place it in the destination array
        ...
        # If the run is empty, remove it from the runs list
        if not runs[smallest_run_index]:
